 ...
 * Use the [airportpickupfragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class airportpickupfragment : Fragment() ,recyclerviewsadapter.OnItemClickListener{
...
var tocheckisbeforetime:String?=null
    ...
    override fun onCreateView(
       ...
       var view= inflater.inflate(R.layout.fragment_airportpickupfragment, container, false)
 ...
 var pickuptextlocationtextview=view.findViewById<TextView>(R.id.pickUpTextView)
        ...
        time.setOnClickListener {
            if(pickuptextlocationtextview.text!="Select destination" )
        ...
        pickuptextlocationtextview.setOnClickListener {
            ...
            intent.putExtra("Came from","PICKUP")
        ...
        selectVehicleButton.setOnClickListener {
            if(pickuptextlocationtextview.text!="Select destination" ) {
                ...
                val heightPixels =
                    resources.displayMetrics.heightPixels / 6  // Adjust height as needed
...
descriptiondetails=description.text.toString()
                ...
                val listener = object : NearbyDriversFinder.OnNearbyDriversFoundListener {
                    override fun onNearbyDriversFound(nearbyDrivers: MutableList<Driver>) {
                        if (nearbyDrivers.isNotEmpty()) {
                            ...
                            adapter.setOnItemClickListener(this@airportpickupfragment)
                ...
                //  createLocationFromTextView(requireContext(),
                //  pickuptextlocationtextview)?.let { it1 ->
                nearbyDriversFinder.findNearbyDrivers(
                    airportLocation, 5000, listener, selectedVehicle
                )
                // }
    ...
    companion object {
         ...
         * @return A new instance of fragment airportpickupfragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            airportpickupfragment().apply {
    ...
    override fun onItemClick(position: Int, driver: Driver) {
        ...
        tripDetails["destination"]=param1.toString()
        tripDetails["pickuplocation"]="Hazrat Shahjalal International Airport"
...
//FirebaseDatabase.getInstance().getReference("Registered users").child(passengerUid).child("Trips").child(tripId.toString()).setValue(tripDetails)
        ...
        if (driver.Token.toString()!=" ")
            sendNotificationToDriver(driver.Token.toString(),"You have received an airport ride request","One passenger has selected you to pickup from Hazrat Shahjalal International Airport and take him to $param1")
        alertDialog.dismiss()
    }
